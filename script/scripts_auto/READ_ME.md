...
## Notes internes de suivi du projet 2020/2021 :
https://docs.google.com/document/d/1uSQTe6EGxvrjdhie0lDHdbBakCjDCNsBbRQIbK9Nrcw/edit

## Tableurs internes au projet :
•	Avancée_travail_corpus : Documente l’avancée de la collecte des données PDF / XML
o		Feuille 1 « Corpus_complet » : liste de toutes les mazarinades recensées par les bibliographes et métadonnées (Vers/Prose, corpus, url PDF, url notice BM, conversion XML, transcription XML)
o		Feuille 2 « PDF_à_vérifier » : liste de documents non répertoriés par les bibliographes trouvés lors de la recherche de PDF et potentiellement intéressants
